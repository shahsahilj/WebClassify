...
public class GetWordsLynx {
	...
	//This method returns a String of the page retrieved by the url. The code initially gets the page as a Set.
	//We have modified the code to return a String in order to be consistent with the logic of our project.
    ...
    public static String runLynx(String url) {
        ...
        try {
            ...
            String cmdline[] = {"C:/cygwin/bin/lynx.exe", "--dump", url };
